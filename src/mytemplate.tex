...
%%% Econometrics Notation, the style file also includes math packages
\input{ee.sty}
...
$endif$
\date{$date$}
%%%%%%%%%%%%%%%%%%%%% new title, author, affiliation, email, and dates
%%%%%%%%%%%%%%%%%%%%% borrow from http://kieranhealy.org/blog/archives/2014/01/23/plain-text/
%$if(title)$
